...
<body>
    ...
    <main class="main-content">
        ...
        <!-- Tab Activos -->
        <div id="tab-actives" class="tab-content <%= "actives".equals(currentTab) ? "active" : "" %> data-table-container">
            <form action="${pageContext.request.contextPath}/loans" method="GET" style="display:flex; gap:10px; margin-bottom: 20px;">
                ...
                <div class="autocomplete-container" style="flex:1;">
                    ...
                    <input type="text" class="form-control autocomplete-input" data-endpoint="${pageContext.request.contextPath}/users?action=apiSearch" data-target="filterLoanUserId" placeholder="Buscar por usuario..." autocomplete="off">
        ...
        <!-- Tab Historial -->
        <div id="tab-history" class="tab-content <%= "history".equals(currentTab) ? "active" : "" %> data-table-container">
            <table class="data-table">
                <thead>
                    <tr>
                        <th>ID Préstamo</th>
        ...
        <div class="modal">
            ...
            <form id="formCreateLoan" action="${pageContext.request.contextPath}/loans" method="POST">
                ...
                <div class="form-group autocomplete-container">
                    ...
                    <input type="text" class="form-control autocomplete-input" data-endpoint="${pageContext.request.contextPath}/users?action=apiSearch" data-target="createLoanUserId" placeholder="Buscar usuario..." required autocomplete="off">
                    <div class="autocomplete-suggestions"></div>
                </div>
                ...
                <div class="form-group autocomplete-container">
                    ...
                    <input type="text" class="form-control autocomplete-input" data-endpoint="${pageContext.request.contextPath}/books?action=apiSearch" data-target="createLoanBookId" placeholder="Buscar libro..." required autocomplete="off">
                    <div class="autocomplete-suggestions"></div>
                </div>
