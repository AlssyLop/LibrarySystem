                ...
                <body>
                    ...
                    <main class="main-content">
                                ...
                                <tbody>
                                    <% List<BookModel> books = (List<BookModel>) request.getAttribute("books");
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%= b.getAuthorName() !=null ? b.getAuthorName() : "ID: " +
                                                        b.getIdAuthor() %>
                                                </td>
                                                <td>
                                            ...
                                            <% } } else { %>
                                                <tr>
                                                    <td colspan="6" style="text-align: center;">No hay registros para
                                                        mostrar</td>
                                                </tr>
                                                <% } %>
                                </tbody>
                        ...
                        <div class="pagination">
                            <% Integer currentPage=(Integer) request.getAttribute("currentPage"); Integer
                                totalPages=(Integer) request.getAttribute("totalPages"); String q=(String)
                                request.getAttribute("query"); if (currentPage !=null && totalPages !=null &&
                                totalPages> 1) {
                            ...
                            <form id="formCreateBook" action="${pageContext.request.contextPath}/books" method="POST">
                                ...
                                <div class="form-group autocomplete-container">
                                    ...
                                    <input type="text" class="form-control autocomplete-input"
                                        data-endpoint="/authors?action=apiSearch" data-target="createBookAuthorId"
                        ...
                        <div class="modal">
                            ...
                            <form id="formEditBook" action="${pageContext.request.contextPath}/books" method="POST">
                                ...
                                <div class="form-group autocomplete-container">
                                    ...
                                    <input type="text" class="form-control autocomplete-input"
                                        data-target="editBookAuthorId" data-endpoint="/authors?action=apiSearch"
                                        placeholder="Buscar autor..." required autocomplete="off">
                                    <div class="autocomplete-suggestions"></div>
                                </div>
                                <div style="text-align: right; margin-top:20px;">
