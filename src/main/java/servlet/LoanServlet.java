    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("list".equals(action)) {
            ...
            request.setAttribute("activeLoans",
                    loanController.listActiveLoansPaginated(limit, offsetActive, idUserSearch, dateFilter));
            request.setAttribute("allLoans",
                    loanController.loanHistoryPaginated(limit, offsetHistory, idUserSearchHist, dateFilterHist));
            ...
            request.setAttribute("activeTotalPages",
                    (int) Math.ceil((double) loanController.countActiveLoans(idUserSearch, dateFilter) / limit));
            request.setAttribute("historyTotalPages",
                    (int) Math.ceil((double) loanController.countHistoryLoans(idUserSearchHist, dateFilterHist) / limit));
